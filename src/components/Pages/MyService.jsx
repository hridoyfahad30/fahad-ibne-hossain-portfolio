    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className="md:w-1/2 border border-gray-600 shadow-2xl shadow-[#ff6f0034] rounded-[60px] p-6 md:p-12 bg-[url('https://i.ibb.co/VHQJ57R/bg.png')] bg-auto bg-no-repeat md:min-h-[450px] bg-right-top"
