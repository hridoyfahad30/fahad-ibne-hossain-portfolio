        ...
        >
            <div id="profile" className="my-36 md:my-12">
                ...
                <div className="md:flex justify-between items-center">
                    ...
                    >
                        ...
                        >
                            I'm a{" "}
                            <span
                                className="text-2xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#7dd2f6] to-[#f0b3f1]">
                <Typewriter
                    options={{
                        strings: [
                ...
                />
                        ...
                        <div
                            className="flex flex-col-reverse md:flex-row justify-center md:justify-start items-center gap-4 my-8">
                            <Link
                                
                                to="https://drive.google.com/u/0/uc?id=1GyDaEsBnn39ScQVBh2foPbFpv2RbKpWf&export=download"
                            >
                                <motion.button
                    ...
                    >
                        ...
                        >
                            <img
                                className="shadow-2xl shadow-[#592525] rounded-3xl"
                                src={hero}
                                alt=""
                            />
                        </div>
