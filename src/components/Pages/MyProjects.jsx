                ...
                <div className="grid md:grid-cols-3 md:gap-12">
                    {projects.map((project) => (
                        <motion.div
                            ...
                            key={project.id}
                            className="card w-96 bg-base-100 shadow-xl relative group my-12 mx-auto"
                        >
                            <figure>
                                <img className="w-96 h-72" src={project.image} alt="project" />
                            </figure>
                            <div
                                className="card-body absolute backdrop-blur-sm min-h-full backdrop-brightness-[30%] hidden group-hover:block w-full rounded-2xl">
