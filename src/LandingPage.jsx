...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      />
      <div>
        <div className="bg-gradient-to-tl from-[#0a3b63af] to-[#0f5c6e63] bg-opacity-20 text-white min-h-screen flex justify-between">
{/* Side Nav Section */}
          <SideNav />

          <div className="md:w-10/12 my-2 mx-6 md:mx-12">
